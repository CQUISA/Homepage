<template>
  <div class="content">
    <el-table :data="tableData" style="width: 100%" :show-overflow-tooltip="false">
      <el-table-column align="center" header-align="center" prop="avatar" width="80">
...
export default {
  data() {
    return {
      tableData: [{
        avatar: 'https://q1.qlogo.cn/g?b=qq&nk=954727918&s=160',
        id: 'v0id',
        grade: '2019级',
        desc: '副社长'
      }, {
